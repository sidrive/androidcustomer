...
import lawyerku.android_customer.ui.register.RegisterActivityCons;

public class LoginActivityCons extends BaseActivity {
  ...
  public void onTvForgotClicked() {
    Intent intent = new Intent(LoginActivityCons.this, ForgotPasswordActivity.class);
...
//    CredentialModel.Request crRequest = new Request();
//    crRequest.email = etUsername.getText().toString();
//    crRequest.password = etPassword.getText().toString();
//
//    loginPresenter.validateLogin(crRequest);

    Intent i = new Intent(LoginActivityCons.this, MainActivityCustomer.class);
    startActivity(i);
  }
...
//        userInput.setText(String.valueOf(barang.getStokBarang()));
  ...
  public void onTvRegisterAskClicked() {
    Intent intent = new Intent(LoginActivityCons.this, RegisterActivityCons.class);
    startActivity(intent);
  }
}
